...
- Direction defines the X axis used for forward projection within the active straight segment. Step length and stride length are measured along that segment axis, and step width is measured on the perpendicular axis.
